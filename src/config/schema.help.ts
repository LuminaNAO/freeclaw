...
export const FIELD_HELP: Record<string, string> = {
  ...
  "gateway.auth.mode":
    'Gateway auth mode: "none", "token", "password", "token-password", or "trusted-proxy" depending on your edge architecture. Use token/password for direct exposure, token-password when remote browsers need both shared secrets, and trusted-proxy only behind hardened identity-aware proxies.',
